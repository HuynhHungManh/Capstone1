...
angular.module('myApp')
    .service('Profile_userService', function ($http) {
        ...
        this.fetchAllUser = function () {
            ...
            return $http.get('https://afternoon-sands-21716.herokuapp.com/api/personals?filter={%22include%22:%20[%22languages%22,%22skills%22,%22jobs%22,%22comments%22,%22interests%22]}');
        };
